...
the twelve classical probability distributions --- plus a three-member
...
Neg.\ binomial \S\ref{sec:negbin}    & Beta \S\ref{sec:beta}               & driver \& tests \S\ref{sec:driver} \\
                                     & Chi-squared \S\ref{sec:chisq}       & cheat sheet \S\ref{sec:cheatsheet} \\
                                     & Student's $t$ \S\ref{sec:studentt}  & \\
                                     & $F$ \S\ref{sec:f}                   & \\
...
\texttt{src/dist.c}.  Three less-common relatives for hash modeling hang
off this tree: the negative binomial (\S\ref{sec:negbin}) is a sum of
geometric waits, and the Rayleigh and Gumbel
