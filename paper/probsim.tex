...
The engine's transition matrix over $\mathbb{F}_2$ has a primitive
characteristic polynomial, which yields the central theorem: the state
sequence is one single cycle through \emph{every} nonzero 256-bit state,
so the period is exactly $2^{256}-1$ \citep{blackman2021xoshiro}.  Two
