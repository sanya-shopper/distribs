...
% the comments — README.md holds the master map.
...
these sections back, so paper and code can be read side by side.
\end{abstract}
...
visible signature of ``many opportunities, each rare''.}
\label{fig:pmfs}
\end{figure}
...
the natural ``know nothing'' prior for a probability.}
\label{fig:beta}
\end{figure}
...
small-sample correction of \S\ref{sec:inference}.}
\label{fig:tvsn}
\end{figure}
